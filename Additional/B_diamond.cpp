...
{
private:
    double foodAll, petrolAll, travelAll;

public:
    SalesPerson(int id, string name, double salary, double foodAll, double petrolAll, double travelAll) : Employee(id, name, salary)
    {
...
public:
    ...
    //	   }
    SalesManager(int id, string name, double salary, string deptname, double pa, double fa, double ta, int deptid) : Manager(id, name, salary, deptname), SalesPerson(id, name, salary, pa, fa, ta), Employee(id, name, salary)
    {
        cout << "--salesManager----" << endl;
        this->deptno = deptid;
    }
